...
class Encoder(nn.Module):
    ...
    def __init__(self, hparams, input_size=36, latent_dim=20):
        super().__init__()
...
class Decoder(nn.Module):
    ...
    def __init__(self, hparams, latent_dim=20, output_size=36):
        super().__init__()
...
class Autoencoder(pl.LightningModule):
    ...
    def validation_step(self, batch, batch_idx):
        ...
        reconstruction = reconstruction.view(
            reconstruction.shape[0], 6,6).cpu().numpy()
        images = np.zeros((len(reconstruction), 3, 6, 6))
    ...
    def getReconstructions(self, loader=None):
        ...
        for batch in loader:
            ...
            reconstructions.append(
                reconstruction.view(-1, 6,6).cpu().detach().numpy())
...
class Classifier(pl.LightningModule):
    ...
    def __init__(self, hparams, encoder, train_set=None, val_set=None, test_set=None):
        ...
        self.model=nn.Sequential(nn.Linear(self.encoder.latent_dim,self.hparams['n_hidden']),
                                 nn.LeakyReLU(),  
